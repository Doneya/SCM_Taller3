...
public class Cliente implements Serializable {
	...
	@NotNull
	@Pattern(regexp="^[SN]{1}$", message="Se permite S o N Mayúscula")
	...
	public Cliente(long clieId, String activo, String direccion, String email, String nombre, String telefono,
